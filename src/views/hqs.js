...
import Dialog from '../componets/Dialogs-hq/Dialog'
import Dialog2 from '../componets/Dialogs-hq/Dialog2'
import Dialog3 from '../componets/Dialogs-hq/Dialog3'
...
const hqs = () => {
  return (
      ...
      <Container sx={{ py: 5 }} maxWidth="md">
        ...
        <Grid container spacing={5}>
            ...
            <Grid item xs={12} sm={6} md={4} >
                 <Card sx={{ height: 400, width: 250 }}  id="card_1">
    ...
    <Card sx={{ height: 400, width: 250 }}  id="card_2">
     ...
     <Dialog2/>
            ...
            <Grid item xs={12} sm={6} md={4}>
                   <Card sx={{ height: 400, width: 250 }}  id="card_3">
