...
import Dialog2 from '../componets/Dialogs/Dialog2'
import Dialog3 from '../componets/Dialogs/Dialog3'
...
const Personagem = () => {
  return (
      ...
      <Container sx={{ py: 5 }} maxWidth="md">
        ...
        <Grid container spacing={5}>
            ...
            <Grid item xs={12} sm={6} md={4} >
                 <Card sx={{ height: 400, width: 250 }}  id="card1">
    ...
    <Card sx={{ height: 400, width: 250 }}  id="card2">
     ...
     <Dialog2/>
            ...
            <Grid item xs={12} sm={6} md={4}>
                   <Card sx={{ height: 400, width: 250 }}  id="card3">
